...
- [src/use_web/](backend/src/use_web/) — frontend-facing layer: `app.py` (FastAPI routes + WebSocket), `image_utils.py` (base64 decode), `headset.py` (adb USB tunnel), `stimulus_control.py` (shared web/VR control state), `rtc_signal.py` (headset-view WebRTC signaling).
